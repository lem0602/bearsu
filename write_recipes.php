                ...
                <section id="write-recipes" class="col-md-10">
                    <div class="write-recipes">
                        ...
                        <div class="upload">
                            ...
                            <input style="display:none;" type="file" name="imgFile[]" id="titleImgFile" accept="image/jpeg,image/jpg" multiple>
                        </div>
                                        ...
                                        <li class="li_list">
                                            <div class="addimg col-12 col-md-4">
                                                <div class="upload">
                                                    ...
                                                    <input style="display:none;" type="file" name="file" id="stepImgFile<?= $i ?>">
                                                </div>
                                            </div>
...
<!-- add the new list -->
<script>
    const form = document.querySelector('#writeRecipes');
